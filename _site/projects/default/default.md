...
To add new posts, simply add a folder in the _projects directory that contains a markdown file (extension .md or .markdown). The file should includes the necessary front matter. Take a look at the source for this post to get an idea about how it works.
